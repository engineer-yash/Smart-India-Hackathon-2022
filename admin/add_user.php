                        ...
                        <div class="text-center mt-4">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <select style="width: auto; height: 37px; font-size: 18px; background-color:powderblue;" name="village">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <select style="width: auto; height: 37px; font-size: 18px; background-color:powderblue;" name="taluka">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <select style="width: auto; height: 37px; font-size: 18px; background-color:powderblue;" name="district">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <select style="width: auto; height: 37px; font-size: 18px; background-color:powderblue;" name="state">
